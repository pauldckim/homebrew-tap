cask "ltop" do
  ...
  version "0.1.2"
  sha256 arm:   "d349b64375fb8263011a625c5f585db0930affdf2c0d0c3e2deb268d84780b47",
         intel: "0fe80dfdb36616059a56a645c3d3eeddf1bd5257150e48141fb063b0b77f2c7c"
  ...
  # 0.1.2 ships both Apple architectures, so the 0.1.0
  ...
  caveats <<~EOS
    ...
    the cached download):
      ...
      shasum -a 256 "$HOME/Library/Caches/Homebrew/downloads/"*--ltop-v0.1.2-macos-*.zip
      # expected (Apple Silicon / arm64):
      #   d349b64375fb8263011a625c5f585db0930affdf2c0d0c3e2deb268d84780b47
      # expected (Intel / x86_64):
      #   0fe80dfdb36616059a56a645c3d3eeddf1bd5257150e48141fb063b0b77f2c7c
